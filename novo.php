        ...
        <div class="well">
          ...
          <div class="row">
			  <div class="col-md-6">
                  ...
                  <div class="col-sm-10"> <input type="number" class="form-control" name="item_pk" id="item_pk" > </div>
              </div>
              <div class="col-md-6">
                                        ...
                                        echo "<select class='form-control' id='disponibilidade' name='disponibilidade' title='disponibilidade' >";
                                            ...
                                            if (mysql_num_rows($query) > 0) {
                                                while($dados = mysql_fetch_array($query)){
                                                    echo "<option value='".$dados['disponibilidade_pk']."'>".utf8_encode($dados['estado'])."</option>";
                                                }
                                            }
                                        echo "</select>"; 
                                    ?></div>
			...
			<div class="row">
				<div class="col-md-7">
					...
					<div class="col-sm-9"><input type="text" class="form-control" name="responsavel" id="responsavel" > </div>
				</div>
				<div class="col-md-5	">
                  ...
                  <div class="col-sm-8"><?php 
                                        echo "<select class='form-control' id='localizacao' name='localizacao' title='localizacao' >";
                                            ...
                                            if (mysql_num_rows($query) > 0) {
                                                while($dados = mysql_fetch_array($query)){
                                                    echo "<option value='".$dados['localizacao_pk']."'>".utf8_encode($dados['lugar'])."</option>";
                                                }
                                            }
                                        echo "</select>"; 
                                    ?></div>
