        ...
        <div class="well">
          ...
          <div class="row-fluid">
              <div class="span4">
                  ...
                  <div class="span9"> <input type="text" class="input-block-level" name="responsavel" id="responsavel" onkeyup="formato_letras_numeros(this)"></div>
              </div>
              <div class="span4">
              ...
              <div class="row-fluid">
                ...
                <div class="row-fluid">
	                <div class="span12"><textarea class="input-block-level pull-left" rows="4" name="descricao" id="descricao" style="resize:none"></textarea></div> 
                </div>
              </div>
          </div>
        ...
        <div class="well">
          ...
          <div class="row-fluid">
              <div class="span3">
                  ...
                  <div class="span5"> <input type="text" class="input-block-level" name="data_compra" id="data_compra" maxlength="10" onKeyUp="formato_data(this)"> </div>
              </div>
              <div class="span2">
                  ...
                  <div class="span6">
                          ...
                          <input type="text" class="input-block-level" name="valor" id="valor" onKeyUp="formato_valor(this)"> 
                        </div>
                   </div>
              </div>
              <div class="span3">
